...
object PaintRoadMapping {
  ...
  def paintRoadMapping(g: FXGraphics2D, roadMapping: RoadMapping): Unit = {
  ...
  def paintRoadMapping(g: FXGraphics2D, roadMapping: RoadMapping, lateralOffset: Double): Unit = {
    assert(!roadMapping.isPeer, "should not be painted twice")
  ...
  def setClipPath(g: FXGraphics2D, roadMapping: RoadMapping, clipPath: GeneralPath): Unit = {
